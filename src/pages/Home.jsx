...
function Home() {
  ...
  return (
    ...
    {
      toggleMenu &&
    <div className={`h-[100vh] w-full scroll-y-none relative ${toggleMenu ? "bg-[#444444]" : "bg-transparent"}`}></div>
    }
    <div className={`block sm:hidden w-[50%] h-[300px] bg-[#737373] fixed right-0 top-0 rounded-lg mt-3 z-50 mr-3 duration-200 ${toggleMenu ? "translate-x-0": "translate-x-[200px]"}`}>
    <button>
